...
TEST_CASE( "PSATResults", "[PSAT results]" ) {
	...
	CHECK(opt.motorEfficiency_ * 100 == Approx(95.4868858345));
	CHECK(opt.motorPowerFactor_ * 100 == Approx(83.9640402732));
	CHECK(opt.motorCurrent_ == Approx(104.7715676829));
	CHECK(opt.motorPower_ == Approx(73.1372514568));
	CHECK(opt.annualEnergy_ == Approx(640.6823227615));
	CHECK(opt.annualCost_ * 1000.0 == Approx(32034.1161380738));
...
//	auto const & mod = psat.getModified();
	...
	CHECK(ex.pumpEfficiency_ * 100 == Approx(79.2348685995));
	CHECK(ex.motorRatedPower_ == Approx(200));
	CHECK(ex.motorShaftPower_ == Approx(102.499232391));
	CHECK(ex.pumpShaftPower_ == Approx(102.499232391));
	CHECK(ex.motorEfficiency_ * 100 == Approx(95.5805342046));
	CHECK(ex.motorPowerFactor_ * 100 == Approx(75.783170653));
	CHECK(ex.motorCurrent_ == Approx(126.9741606683));
	CHECK(ex.motorPower_ == Approx(80));
	CHECK(ex.annualEnergy_ == Approx(700.8));
	CHECK(ex.annualCost_ * 1000.0 == Approx(35040));
...
//	CHECK(mod.annualCost_ * 1000.0 == Approx(35151.7585385623));
	...
	CHECK(opt.motorPower_ == Approx(73.1372514568));
	CHECK(opt.annualEnergy_ == Approx(640.6823227615));
	CHECK(opt.annualCost_ * 1000.0 == Approx(32034.116138073));
