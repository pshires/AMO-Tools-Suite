...
double OptimalMotorPower::calculate() {
    ...
    double mspkW = 0.0;
    while (true) {
        OptimalMotorCurrent optimalMotorCurrent(motorRatedPower_, motorRPM_, lineFrequency_, Motor::EfficiencyClass::PREMIUM,
        ...
        MotorEfficiency motorEfficiency(lineFrequency_, motorRPM_, Motor::EfficiencyClass::PREMIUM, specifiedEfficiency_,
                                        motorRatedPower_,
                                        tempLoadFraction_);
